...
import ladyjek.twiscode.com.ladyjek.Adapter.HelpSliderAdapter;
...
public class ActivityHelp extends FragmentActivity {
    ...
    void SetImageSlideView(){
        ...
        HelpSliderAdapter defaultPagerAdapter = new HelpSliderAdapter(getSupportFragmentManager(),ApplicationData.promo_images);
